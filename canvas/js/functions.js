    ...
    function(e) {
        ...
        SEMICOLON.initialize = {
            ...
            goToTop: function() {
                ...
                i || (i = 700), n || (n = "easeOutQuad"), K.off("click").on("click", function() { return e("body,html").stop(!0).animate({ scrollTop: 0 }, Number(i), n), !1 })
            },
            ...
            topScrollOffset: function() { let e = 0; return !r.hasClass("device-xl") && !r.hasClass("device-lg") || SEMICOLON.isMobile.any() ? e = 40 : (e = u.hasClass("sticky-header") ? q.hasClass("dots-menu") ? 100 : 144 : q.hasClass("dots-menu") ? 140 : 184, q.length || (e = u.hasClass("sticky-header") ? 100 : 140)), e },
            ...
            initialize: function() { a = c.outerHeight(), c.length > 0 && (e(".header-wrap-clone").length < 1 && c.after('<div class="header-wrap-clone"></div>'), E = e(".header-wrap-clone")), q.length > 0 && (q.find("#page-menu-wrap").after('<div class="page-menu-wrap-clone"></div>'), B = e(".page-menu-wrap-clone")), e(".menu-item:has(.sub-menu-container)").addClass("sub-menu"), e(".top-links-item:has(.top-links-sub-menu,.top-links-section) > a:not(:has(.icon-angle-down)), .menu-item:not(.mega-menu-title):has(.sub-menu-container) > .menu-link > div:not(:has(.icon-angle-down)), .page-menu-item:has(.page-menu-sub-menu) > a > div:not(:has(.icon-angle-down))").append('<i class="icon-angle-down"></i>'), e(".menu-item:not(.mega-menu-title):has(.sub-menu-container):not(:has(.sub-menu-trigger))").append('<button class="sub-menu-trigger icon-chevron-right"></button>'), SEMICOLON.header.menuInvert() },
            ...
            menufunctions: function() {
                ...
                d = Number(d), i = n.children(".sub-menu-trigger"), r.hasClass("device-xl") || r.hasClass("device-lg") ? (setTimeout(function() { E.length > 0 && E.css({ height: a }), SEMICOLON.header.includeOffset() }, 1e3), M.find(l).css({ display: "" })) : g.css({ "margin-top": "" }), r.hasClass("overlay-menu") && M.hasClass("on-click") && (r.hasClass("device-xl") || r.hasClass("device-lg")) ? t.off("click").on("click", function(i) {
                    let n = e(this);
                    n.parents(".sub-menu").siblings().find(l).stop(!0, !0).slideUp(d), n.parent(o).children(s).stop(!0, !0).slideToggle(d), i.preventDefault()
                }) : r.hasClass("side-header") && M.hasClass("on-click") || r.hasClass("device-md") || r.hasClass("device-sm") || r.hasClass("device-xs") ? (i.removeClass("icon-rotate-90"), e(o).find(l).filter(":not(:animated)").stop(!0, !0).slideUp(d, function() { r.toggleClass("primary-menu-open", !1) }), (i = i.add(t.filter('[href^="#"]'))).off("click").on("click", function(i) {
                    let n = e(this);
                ...
                })) : (r.hasClass("overlay-menu") || r.hasClass("side-header")) && (r.hasClass("device-xl") || r.hasClass("device-lg")) ? (M.find(l).stop(!0, !0).slideUp(d), e(o).hover(function(i) { e(this).children(s).stop(!0, !0).slideDown(d) }, function() { e(this).children(s).stop(!0, !0).slideUp(d) })) : M.hasClass("on-click") && t.off("click").on("click", function(i) {
                    let n = e(this);
                ...
                }), (e(".top-links").hasClass("on-click") || r.hasClass("device-md") || r.hasClass("device-sm") || r.hasClass("device-xs")) && e(".top-links-item:has(.top-links-sub-menu,.top-links-section) > a").on("click", function(i) { e(this).parents("li").siblings().find(".top-links-sub-menu,.top-links-section").removeClass("d-block"), e(this).parent("li").children(".top-links-sub-menu,.top-links-section").toggleClass("d-block"), i.preventDefault() }), SEMICOLON.header.menuInvert(e(".top-links-section")), e("#primary-menu-trigger").off("click").on("click", function() { return (r.hasClass("device-md") || r.hasClass("device-sm") || r.hasClass("device-xs")) && (M.find(".mobile-primary-menu").length > 0 ? (e(".primary-menu:not(.mobile-menu-off-canvas) .mobile-primary-menu").stop(!0, !0).slideToggle(d), e(".primary-menu.mobile-menu-off-canvas .mobile-primary-menu").toggleClass("d-block")) : (e(".primary-menu:not(.mobile-menu-off-canvas) .menu-container").stop(!0, !0).slideToggle(d), e(".primary-menu.mobile-menu-off-canvas .menu-container").toggleClass("d-block"))), r.toggleClass("primary-menu-open"), !1 }), e(".menu-container:not(.mobile-primary-menu)").css({ display: "" }), (r.hasClass("device-xl") || r.hasClass("device-lg")) && M.find(".mobile-primary-menu").removeClass("d-block")
            },
            ...
            stickyPageMenu: function(e) {
                if (o.scrollTop() > e)
                    if (r.hasClass("device-xl") || r.hasClass("device-lg")) {
                        ...
                        let e = c.outerHeight();
                        u.length > 0 && !u.hasClass("no-sticky") && q.filter(".sticky-page-menu:not(.dots-menu,.no-sticky)").find(V).css({ top: e + "px" })
            ...
            sidePanel: function() { e(".side-panel-trigger").off("click").on("click", function() { return r.toggleClass("side-panel-open"), r.hasClass("device-touch") && r.hasClass("side-push-panel") && r.toggleClass("ohidden"), !1 }) },
            ...
            stickyMenuClass: function() {
                ...
                w && (e = w.split(/ +/));
                let i = e.length;
                if (i > 0) { let n = 0; for (n = 0; n < i; n++) "not-dark" == e[n] ? (u.removeClass("dark"), c.filter(":not(.not-dark)").addClass("not-dark")) : "dark" == e[n] ? (c.removeClass("not-dark force-not-dark"), u.hasClass(e[n]) || u.addClass(e[n])) : u.hasClass(e[n]) || u.addClass(e[n]) }
            },
            responsiveMenuClass: function() {
                ...
                x && (e = x.split(/ +/));
                let i = e.length;
                if (i > 0) { let n = 0; for (n = 0; n < i; n++) "not-dark" == e[n] ? (u.removeClass("dark"), c.addClass("not-dark")) : "dark" == e[n] ? (c.removeClass("not-dark force-not-dark"), u.hasClass(e[n]) || u.addClass(e[n])) : u.hasClass(e[n]) || u.addClass(e[n]) }
                SEMICOLON.header.logo()
            },
            topsearch: function() {
                G.parents(".header-row").addClass("top-search-parent");
                let i = u.find(".top-search-parent");
                e("#top-search-trigger").off("click").on("click", function(e) { clearTimeout(n), r.toggleClass("top-search-open"), X.toggleClass("top-cart-open", !1), (r.hasClass("device-md") || r.hasClass("device-sm") || r.hasClass("device-xs")) && (M.filter(":not(.mobile-menu-off-canvas)").find(".menu-container").slideUp(200), M.filter(".mobile-menu-off-canvas").find(".menu-container").toggleClass("d-block", !1)), r.hasClass("top-search-open") ? i.toggleClass("position-relative", !0) : n = setTimeout(function() { i.toggleClass("position-relative", !1) }, 750), r.toggleClass("primary-menu-open", !1), q.toggleClass("page-menu-open", !1), r.hasClass("top-search-open") && G.find("input").focus(), e.stopPropagation(), e.preventDefault() })
            },
            topcart: function() {
                if (X.length < 1) return !0;
                e("#top-cart-trigger").off("click").on("click", function(e) { q.toggleClass("page-menu-open", !1), X.toggleClass("top-cart-open"), e.stopPropagation(), e.preventDefault() })
            },
            ...
            sliderDimensions: function() {
                ...
                if (r.hasClass("device-xl") || r.hasClass("device-lg")) {
                    if (setTimeout(function() { n.height(e), a && (e = U.find(".slider-inner").children().first().outerHeight(), U.height(e), n.height(e)) }, 500), a) {
            ...
            sliderParallax: function() {
                ...
                let e, i, n = SEMICOLON.slider.sliderParallaxOffset(),
                    a = U.outerHeight();
                t = window.pageXOffset, s = window.pageYOffset, !r.hasClass("device-xl") && !r.hasClass("device-lg") || SEMICOLON.isMobile.any() ? (U.find(".slider-inner").length > 0 ? (SEMICOLON.slider.sliderParallaxSet(0, 0, ne), SEMICOLON.slider.sliderParallaxSet(0, 0, ie)) : (SEMICOLON.slider.sliderParallaxSet(0, 0, ee), SEMICOLON.slider.sliderParallaxSet(0, 0, ie)), U.addClass("slider-parallax-visible").removeClass("slider-parallax-invisible")) : (a + n + 50 > s ? (U.addClass("slider-parallax-visible").removeClass("slider-parallax-invisible"), s > n ? U.find(".slider-inner").length > 0 ? (e = -.4 * (s - n), i = -.15 * (s - n), SEMICOLON.slider.sliderParallaxSet(0, e, ne), SEMICOLON.slider.sliderParallaxSet(0, i, ie)) : (e = (s - n) / 1.5, i = (s - n) / 7, SEMICOLON.slider.sliderParallaxSet(0, e, ee), SEMICOLON.slider.sliderParallaxSet(0, i, ie)) : U.find(".slider-inner").length > 0 ? (SEMICOLON.slider.sliderParallaxSet(0, 0, ne), SEMICOLON.slider.sliderParallaxSet(0, 0, ie)) : (SEMICOLON.slider.sliderParallaxSet(0, 0, ee), SEMICOLON.slider.sliderParallaxSet(0, 0, ie))) : U.addClass("slider-parallax-invisible").removeClass("slider-parallax-visible"), requestAnimationFrame(function() { SEMICOLON.slider.sliderParallax(), SEMICOLON.slider.sliderElementsFade() }))
            },
            sliderElementsFade: function() {
                ...
                if (!r.hasClass("device-xl") && !r.hasClass("device-lg") || SEMICOLON.isMobile.any()) U.find(".slider-arrow-left,.slider-arrow-right,.slider-caption,.slider-element-fade").css({ opacity: 1 });
                    ...
                    e = u.hasClass("transparent-header") || r.hasClass("side-header") ? 100 : 0, U.filter(".slider-parallax-visible").find(".slider-arrow-left,.slider-arrow-right,.slider-caption,.slider-element-fade").css({ opacity: 1 - 1.85 * (s - e) / i })
                }
            },
            ...
            gmap: function(e) {
                let i = { element: e, default: ".gmap", file: "https://maps.google.com/maps/api/js?key=" + Z, error: "Google Maps API could not be loaded", execfn: !1, pluginfn: 'typeof google !== "undefined"', hiddendisable: !0, class: "has-plugin-gmapapi" },
            ...
            extras: function() {
                ...
                if (e(".style-msg").on("click", ".close", function(i) { e(this).parents(".style-msg").slideUp(), i.preventDefault() }), e("#page-menu-trigger").off("click").on("click", function() { return r.toggleClass("top-search-open", !1), q.toggleClass("page-menu-open"), !1 }), q.find("nav").off("click").on("click", function(e) { r.toggleClass("top-search-open", !1), X.toggleClass("top-cart-open", !1) }), SEMICOLON.isMobile.any() && r.addClass("device-touch"), r.hasClass("adaptive-color-scheme")) {
                    let i = e("[data-adaptive-light-class], [data-adaptive-dark-class]"),
                        ...
                        s = function(e) { e ? (r.toggleClass("dark", !0), i.removeClass(n).addClass(t)) : (r.toggleClass("dark", !1), i.removeClass(t).addClass(n)), SEMICOLON.header.logo() };
                ...
                r.off("click").on("click", 'a[href*="#"]', function() { o.on("beforeunload", function() { o.scrollTop(0) }) });
                let n = location.hash;
                e(n).length > 0 && e(".one-page-menu").find('[data-href="' + n + '"]').length > 0 && o.scrollTop(0)
            }
        }, SEMICOLON.isMobile = { Android: function() { return navigator.userAgent.match(/Android/i) }, BlackBerry: function() { return navigator.userAgent.match(/BlackBerry/i) }, iOS: function() { return navigator.userAgent.match(/iPhone|iPad|iPod/i) }, Opera: function() { return navigator.userAgent.match(/Opera Mini/i) }, Windows: function() { return navigator.userAgent.match(/IEMobile/i) }, any: function() { return SEMICOLON.isMobile.Android() || SEMICOLON.isMobile.BlackBerry() || SEMICOLON.isMobile.iOS() || SEMICOLON.isMobile.Opera() || SEMICOLON.isMobile.Windows() } }, SEMICOLON.customization = { onReady: function() {}, onLoad: function() {}, onResize: function() {} }, SEMICOLON.documentOnResize = { init: function() { SEMICOLON.header.menufunctions(), SEMICOLON.header.fullWidthMenu(), SEMICOLON.header.stickyMenu(), SEMICOLON.header.logo(), SEMICOLON.initialize.dataResponsiveHeights(), SEMICOLON.initialize.stickFooterOnSmall(), SEMICOLON.slider.sliderDimensions(), SEMICOLON.slider.sliderParallax(), SEMICOLON.widget.html5Video(), SEMICOLON.widget.masonryThumbs(), SEMICOLON.initialize.dataResponsiveClasses(), SEMICOLON.customization.onResize(), L = o.width(), e(window).trigger("scwWindowResize") } }, SEMICOLON.documentOnReady = {
            init: function() { SEMICOLON.initialize.init(), SEMICOLON.header.init(), (Q.length > 0 || J.length > 0) && SEMICOLON.slider.init(), W.length > 0 && SEMICOLON.portfolio.init(), SEMICOLON.widget.init(), SEMICOLON.documentOnReady.windowscroll(), SEMICOLON.customization.onReady() },
            windowscroll: function() {
                ...
                q.length > 0 && (B.css({ height: q.find("#page-menu-wrap").outerHeight() }), setTimeout(function() { u.length > 0 && !u.hasClass("no-sticky") && (r.hasClass("device-xl") || r.hasClass("device-lg") || "true" == m) ? (ae = q.offset().top - c.outerHeight(), s.appendChild(a), n = "#page-menu.sticky-page-menu:not(.dots-menu) #page-menu-wrap { top: " + t + "px; }", a.type = "text/css", a.appendChild(document.createTextNode(n))) : ae = q.offset().top }, 1e3)), SEMICOLON.header.stickyMenu(se), SEMICOLON.header.stickyPageMenu(ae), window.addEventListener("scroll", function() { SEMICOLON.initialize.goToTopScroll(), e("body.open-header.close-header-on-scroll").removeClass("side-header-open"), SEMICOLON.header.stickyMenu(se), SEMICOLON.header.stickyPageMenu(ae), SEMICOLON.header.logo() }, { passive: !0 }), window.addEventListener("DOMContentLoaded", onScrollSliderParallax, !1), o.scrollEnd(function() {
                    let e = c.outerHeight();
                    q.length > 0 && u.length > 0 && !u.hasClass("no-sticky") && (r.hasClass("device-xl") || r.hasClass("device-lg")) && q.filter(".sticky-page-menu:not(.dots-menu,.no-sticky)").find(V).css({ top: e + "px" })
                }, 500)
            }
        ...
        e(document).ready(SEMICOLON.documentOnReady.init), o.on("load", SEMICOLON.documentOnLoad.init), o.on("resize", function() {
            let i = e(this);
            clearTimeout(l), l = setTimeout(function() { i.width() !== L && SEMICOLON.documentOnResize.init() }, 250)
        })
    }(jQuery), jQuery(document).ready(function() { jQuery(".disable-pagetransition").on("click", function() { return jQuery("body").addClass("no-transition"), jQuery(".page-transition-wrap").fadeOut(400, function() { jQuery(this).remove() }), !1 }) }), jQuery.get("switcher-html.html", function(e) { jQuery("#gotoTop").after(e), jQuery(".scw-trigger").on("click", function() { jQuery(".scw-switcher-wrap").toggleClass("scw-switcher-open") }), jQuery(document).on("click", function(e) { jQuery(e.target).closest(".scw-switcher-wrap").length || jQuery(".scw-switcher-wrap").toggleClass("scw-switcher-open", !1) }) });
